...
its style, performance, readability and maintainability. If there are any reputable libraries that could 
be introduced to improve the code, suggest them. Be kind and constructuve. For each suggested change, include line numbers
to which you are reffering. 
"""
...
# if this file is directly invoked then call this logic
